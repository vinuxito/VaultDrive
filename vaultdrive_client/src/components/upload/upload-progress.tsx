...
export function UploadProgress({
  ...
  return (
    <div className={cn('glass rounded-xl overflow-hidden', className)}>
      ...
      {activeCount > 0 && (
        <div className="px-4 py-2 border-t border-primary/15 bg-primary/3">
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-2 flex-shrink-0 ml-2">
          ...
          {isActive && (
            <button
              onClick={onCancel}
              className="p-1 text-muted-foreground hover:text-foreground hover:bg-primary/10 rounded transition-colors"
              title="Cancel upload"
            >
              <X className="w-4 h-4" />
            </button>
