    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-background/90 flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-4">
        <div className="text-center mb-2">
          ...
          <p className="text-muted-foreground text-sm">{t("drive:publicShare.secureShare", "Secure File Share")}</p>
        </div>

        <div className="bg-card rounded-2xl shadow-2xl border border-border p-8 text-foreground">
          {state === "loading" && (
            <div className="flex flex-col items-center gap-4 py-4">
              <Loader2 className="w-10 h-10 animate-spin text-primary" />
              <p className="text-muted-foreground">{t("drive:publicShare.verifying", "Verifying share link…")}</p>
            </div>
          )}
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                <div className="shrink-0 w-14 h-14 rounded-xl bg-muted flex items-center justify-center border border-border">
                  <FileIconComponent className="w-7 h-7 text-primary" />
                </div>
            ...
            branding.productSlug.includes("quantix") ? (
              <div className="flex flex-col items-center gap-6 py-4 text-center">
                ...
                <div className="space-y-3">
                  <h2 className="text-lg font-bold text-foreground tracking-wide font-mono uppercase">
              ...
              <div className="flex flex-col items-center gap-6 py-4 text-center">
                <div className="relative w-24 h-24 flex items-center justify-center bg-muted rounded-full border border-border shadow-inner">
                  <svg className="w-20 h-20 text-muted-foreground" viewBox="0 0 100 100">
                ...
                <div className="space-y-3">
                  <h2 className="text-lg font-medium text-foreground tracking-normal">
                    {t("drive:publicShare.lockedTitle", "Time-Locked Release")}
                  </h2>

                  {timeLeft && (
                    <div className="text-xl font-light text-muted-foreground tracking-wide font-sans bg-muted px-5 py-2.5 rounded-full border border-border shadow-lg inline-block">
              ...
              <div className="w-full text-left bg-muted border border-border rounded-lg p-4 font-mono text-xs space-y-2 mt-2">
                ...
                <div className="space-y-1">
                  <div className="flex justify-between border-b border-border pb-1">
                    <span className="text-muted-foreground">{t("drive:publicShare.algo", "Algorithm:")}</span>
                    <span>AES-256-GCM</span>
                  </div>
                  <div className="flex justify-between border-b border-border pb-1">
                    <span className="text-muted-foreground">{t("drive:publicShare.keySource", "Key Source:")}</span>
          ...
          {state === "expired" && (
            <div className="flex flex-col items-center gap-4 py-2 text-center">
              ...
              <div>
                <p className="text-lg font-semibold text-foreground">{t("drive:publicShare.expiredTitle", "This link has expired")}</p>
