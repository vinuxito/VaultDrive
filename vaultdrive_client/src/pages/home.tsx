      ...
      <section className="container mx-auto px-4 py-16 mb-12">
        <div className="max-w-3xl mx-auto">
          <div className="brand-glass-card p-8">
            <h2 className="text-xl font-semibold mb-4 brand-section-heading">
              {`About ${branding.productName}`}
            </h2>
            <div className="space-y-3 text-sm text-muted-foreground">
              <p>
                {`${branding.productName} is an enterprise-grade zero-knowledge encrypted cloud storage platform`}
